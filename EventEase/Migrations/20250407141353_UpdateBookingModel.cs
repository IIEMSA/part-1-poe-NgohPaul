        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenueName = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Venue__3C57E5F2DF8CD0D9", x => x.VenueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Event__7944C810896A0178", x => x.EventId);
                    table.ForeignKey(
                        name: "FK__Event__VenueId__4BAC3F29",
                        column: x => x.VenueId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Booking__73951AED0F21345E", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK__Booking__EventId__4E88ABD4",
                        column: x => x.EventId,
                        principalTable: "Event",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Booking__VenueId__4F7CD00D",
                        column: x => x.VenueId,
                        principalTable: "Venue",
                        principalColumn: "VenueId",
                        onDelete: ReferentialAction.Cascade);
